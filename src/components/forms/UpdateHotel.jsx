        ...
        <form method='POSt' onSubmit={updateHotel}>
          <div className='mx-8 flex flex-col gap-3'>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className='flex gap-2'>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setHotel({
                      ...hotel,
                      Name_of_hotel_company: e.target.value,
                    })
                  }
                />
              </div>
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    defaultValue={hotel.Authoried_signatory_name}
                    ...
                    onChange={(e) =>
                      setHotel({
                        ...hotel,
                        Authoried_signatory_name: e.target.value,
                      })
                    }
                  />
                </div>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    required
                    value={hotel.Authoried_signatory_designation}
                    defaultValue={hotel.Authoried_signatory_designation}
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({
                        ...hotel,
                        Authoried_signatory_designation: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Mobile_no: e.target.value })
                    }
                  />
                </div>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Landline_no: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  <label for='email' className='text-md dark:text-gray-50 w-60'>
                    Email
                  </label>
                  <input
                    type='email'
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Hotel_email: e.target.value })
                    }
                  />
                </div>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Website_hotel: e.target.value })
                    }
                  />
                </div>
              </div>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setHotel({ ...hotel, Business_manager: e.target.value })
                    }
                  >
                    <option value='swagstay' className='text-sm'>
                      Swagstay
                    </option>
                    <option value='swagstay' className='text-sm'>
                      Fahim Ali
                ...
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Contact_no: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className='flex justify-between'>
                ...
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setHotel({ ...hotel, Website_swag_info: e.target.value });
                    }}
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                  />
                </div>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    value={hotel.Authoried_signatory_designationswagName}
                    defaultValue={hotel.Authoried_signatory_designationswagName}
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({
                        ...hotel,
                        Authoried_signatory_designationswagName: e.target.value,
                      })
                    }
                  />
                </div>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    value={hotel.Authoried_signatory_designationSwag}
                    defaultValue={hotel.Authoried_signatory_designationSwag}
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({
                        ...hotel,
                        Authoried_signatory_designationSwag: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div className='flex justify-between'>
                ...
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Total_rooms: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  ...
                  <select
                    ...
                    className='border-gray-300 focus:border-yellow-700 bg-gray-50 dark:text-gray-50 dark:bg-gray-600 flex h-8 w-[11.47rem] items-center rounded border-2'
                    onChange={(e) =>
                      setHotel({ ...hotel, Hotel_type: e.target.value })
                    }
                  >
                    <option value='Delux' className='text-sm'>
                      Delux Hotel
                    </option>
                    <option value='Luxury' className='text-sm'>
                      Luxury Hotel
                    </option>
                    <option value='Resort' className='text-sm'>
                      Resort Hotels
                    </option>
                  </select>
                </div>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, GSTN_no: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  <label for='city' className='text-md dark:text-gray-50 w-60'>
                    City
                  </label>
                  <select
                    required
                  ...
                  >
                    <option value='Nagpur' className='text-sm'>
                      Nagpur
                    </option>
                    <option value='Jaipur' className='text-sm'>
                      Jaipur
                    </option>
                    <option value='Pune' className='text-sm'>
                      Pune
                    </option>
                    <option value='Goa' className='text-sm'>
                      Goa
                    </option>
                    <option value='Nashik' className='text-sm'>
                      Nashik
                    </option>
                    <option value='Indore' className='text-sm'>
                      Indore
                    </option>
                    <option value='Wardha' className='text-sm'>
                      Wardha
                    </option>
                    <option value='Chandrapur' className='text-sm'>
                      Chandrapur
                    </option>
                    <option value='Bhopal' className='text-sm'>
                      Bhopal
                    </option>
                    <option value='Kashi' className='text-sm'>
                      Kashi
                    </option>
                    <option value='Kanha' className='text-sm'>
                      Kanha
                    </option>
                  </select>
                </div>
                <div className='flex gap-2'>
                  <label for='map' className='text-md dark:text-gray-50 w-60'>
                    Map Link
                  </label>
                  <input
                    type='text'
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Map_link: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Locality: e.target.value })
                    }
                  />
                </div>
                <div className='flex gap-2'>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  <label for='zip' className='text-md dark:text-gray-50 w-60'>
                    Zip Code
                  </label>
                  <input
                    onKeyDown={(e) => {
                    ...
                    className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 h-8 rounded border-2 p-1.5'
                    onChange={(e) =>
                      setHotel({ ...hotel, Zip_code: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className='flex justify-between'>
                <div className='flex gap-2'>
                  ...
                  <select
                    ...
                    className='border-gray-300 focus:border-yellow-700 bg-gray-50 dark:text-gray-50 dark:bg-gray-600 flex h-8 w-[11.47rem] items-center rounded border-2'
                    onChange={(e) =>
                      setHotel({ ...hotel, Commision: e.target.value })
                    }
                  >
                    <option value='swagstay' className='text-sm'>
                      Swag18
                ...
                <div className='flex gap-2'>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setHotel({ ...hotel, Small_description: e.target.value })
                    }
                  />
                </div>
              </div>
              <div className='flex gap-2'>
                ...
                <textarea
                  ...
                  className='bg-gray-50 dark:text-gray-50 dark:bg-gray-600 border-gray-300 focus:border-yellow-700 rounded border-2 p-1.5'
                  onChange={(e) =>
                    setHotel({ ...hotel, Meta_discription: e.target.value })
                  }
                />
              </div>
            </div>
