...
import { BiDownload, BiHotel } from "react-icons/bi";
import { FaUserSecret, FaRegListAlt } from "react-icons/fa";
import {
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden border-r-2 border-strokedark  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
                      ...
                      >{' '}
                            ...
                            <li>
                                <NavLink
                                    to="/agentBooking"
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                        pathname.includes("agentBooking") &&
                                        "bg-graydark dark:bg-meta-4"
                                    }`}
                                >
                                    <FaUserSecret />
                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            to="/web-master/upcomingProperty"
                                                            className={({
                                                                isActive,
                                                            }) =>
                                                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
