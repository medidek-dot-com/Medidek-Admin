...
const PmsSidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <aside
            ref={sidebar}
            className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden border-r-2 border-strokedark bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        ...
        >
            ...
            <div className="flex items-center justify-between gap-2 px-6 py-5.5">
                ...
                <button
                    ...
                    className="block text-4xl hover:text-meta-6 lg:hidden"
                >
                    ×
                </button>
            </div>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >{' '}
                            ...
                            <li>
                                <NavLink
                                    to={`/swagmanager/${id}/price`}
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                        pathname.includes("price") &&
                                        "bg-graydark dark:bg-meta-4"
                                    }`}
                                >
                                    <FaDollarSign className="h-6 w-5" />
                                    Price
                                </NavLink>
                            </li>
                            <li>
                                <NavLink
                                    to={`/swagmanager/${id}/report`}
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                        (pathname === "/report" ||
                            ...
                            <li>
                                <NavLink
                                    to={`/swagmanager/${id}/roomReport`}
                                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                        (pathname === "/roomReport" ||
                                            pathname.includes("roomReport")) &&
                                        "bg-graydark dark:bg-meta-4"
                                    }`}
                                >
                                    <svg
                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <NavLink
                                                            to={`/swagmanager/${id}/settings/rooms`}
                                                            className={({
                                                                isActive,
                                                            }) =>
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            to={`/swagmanager/${id}/settings/users`}
                                                            className={({
                                                                isActive,
                                                            }) =>
                                                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            to={`/swagmanager/${id}/settings/property`}
                                                            className={({
                                                                isActive,
                                                            }) =>
                                                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white " +
